...
See [claim-state extension rules](../../docs/idd-claim-state-rules.md).

## Legacy claim migration

Read the [legacy claim migration rules](../../docs/idd-claim-state-rules.md)
before interpreting trusted legacy comments or posting a migration claim.
